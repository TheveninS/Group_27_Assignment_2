...
/**
 * Adjust Target Prices Higher Screen
 * @author anush
 */
public class AdjustPricesHigherJPanel extends javax.swing.JPanel {
    ...
    public AdjustPricesHigherJPanel(Business bz, JPanel jp) {
    ...
    private void loadRecommendations() {
        ...
        lblTotalRecommendations.setText("Recommendations: " + recommendations.size() + " products can have higher prices");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adjust Target Prices Higher");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 550, -1));

        jLabel2.setText("Products selling above target (>70% of sales) - can increase price");
    ...
    private void btnApplyActionPerformed(java.awt.event.ActionEvent evt) {
        int confirm = JOptionPane.showConfirmDialog(this,
            "Apply " + recommendations.size() + " price adjustments?\nThis will increase target prices for products selling above target.",
            "Confirm Changes",
